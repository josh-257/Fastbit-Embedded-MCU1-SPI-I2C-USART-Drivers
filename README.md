...
I've made some additions, one of them being adding a private function (RCC_GetPLLOutputClock()) to my RCC driver, allowing me to use the RCC API's with PLL selected as the clock source.
